...
1. Read `${GSTACK_ROOT:-$HOME/.claude/skills/gstack}/review/checklist.md`. If the file cannot be read, **STOP** and report the error.
...
> You are classifying Greptile review comments for a /ship workflow. Read `${GSTACK_ROOT:-$HOME/.claude/skills/gstack}/review/greptile-triage.md` and follow the fetch, filter, classify, and **escalation detection** steps. Do NOT fix code, do NOT reply to comments, do NOT commit — report only.
>
...
Read `${GSTACK_ROOT:-$HOME/.claude/skills/gstack}/review/TODOS-format.md` for the canonical format reference.
