...
Read `${GSTACK_ROOT:-$HOME/.claude/skills/gstack}/review/checklist.md`.
...
Read `${GSTACK_ROOT:-$HOME/.claude/skills/gstack}/review/greptile-triage.md` and follow the fetch, filter, classify, and **escalation detection** steps.
