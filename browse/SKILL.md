...
$B goto "file://$HOME/Documents/page.html"   # absolute home path after shell expansion
...
$B prettyscreenshot --cleanup --scroll-to ".pricing" --width 1440 "$TMP_ROOT/hero.png"
```
