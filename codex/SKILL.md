...
description: |
  ...
  A terse, independent technical second opinion. Use when asked to "codex review",
...
technically precise second opinion from a different AI system.

Treat Codex as an external reviewer, not as authority. It should challenge assumptions,
surface risks you might miss, and stay direct. Present its output faithfully, without
truncation, then note any material disagreement or obvious tool-rabbit-hole failure after
the verbatim block.
